        (function () {
            ...
            function renderReportContent(data, isNew = true) {
                ...
                // 하단 (생성 정보)
                body.appendChild(el('div', { style: { textAlign: 'center', padding: '8px 0', color: 'var(--grey-5)', fontSize: '12px', marginTop: '16px', borderTop: '1px solid var(--grey-7)', paddingTop: '16px' } }, ['Generated by Carmore AI \u00B7 ' + (data.generated_at || new Date().toLocaleString('ko-KR'))]));
            }
