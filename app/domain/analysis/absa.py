...
from .patterns import (
    NEGATIVE_REGEX, POSITIVE_REGEX, DOUBLE_NEGATION_REGEX,
    POSITIVE_EXCEPTION_REGEX, GENERAL_POSITIVE_KEYWORDS
)
...
class RuleBasedABSA:
    ...
    def __init__(self, chunker: Optional[ClauseChunker] = None):
        """
        초기화
